...
const donatePage = {
  ...
  description2: {
    ...
    ukrainian: 'Please note that monthly payments are the default option.',
  },
  description3: {
    english:
        ...
        <Section className={style.section} id="donorBox">
          <div className={style.topContainer}>
            ...
            <H2 className={style.description}>
              ...
              <span className={`${style.redText} ${style.block}`}>
                {donatePage.description2[lang]}
              </span>
              <span>
          ...
          <div className={style.bottomContainer}>
            ...
            <div className={style.right}>
              ...
              <iframe
                src="https://donorbox.org/embed/website-donation-64-2"
                name="donorbox"
                seamless={true}
