...
const prostheticsSection = {
  cards: {
    free: {
      english: 'Free prosthetics for those who need them as a result of the war in Ukraine.',
      ukrainian: 'Безкоштовні протези для тих, хто потребує їх унаслідок війни в Україні.',
    },
    psychological: {
      english: 'Mental health and emotional support for victims of war during their recovery.',
      ukrainian: 'Психологічна та емоційна підтримка жертв війни під час їх реабілітації.',
    },
    unite: {
...
const donatePage = {
  ...
  monthlyPayment: {
    ...
    ukrainian: 'Зверніть увагу, що щомісячні платежі є параметром за замовчуванням.',
  },
  strongSupport: {
    english:
